 *Autor do projeto: 
Thiago Martins de Oliveira (Analista de dados)

*Líder da Equipe de importação: 
Douglas Westley

*Equipe de desenvolvimento:
Marianne Bechega (Analista de dados)
Caroline Attilio
...
- O shiny cria um arquivo web, o que nos permite adicionar HTML, CSS e JS
- Estamos estudando como colocar scripts de Python
- A identidade visual foi inspirada na página do Doctoralia Tech
- A documentação, e os tutoriais de uso e contribuição estão em desenvolvimento
